...
<body>
    ...
    <div class="banner jarallax">
        ...
        <div class="welcome" id="about">
            <div class="container">
                <div class="col-md-6 agileits_welcome_grid_left">
                    <h3>About Us!</h3>
                    <h5 style="color: white;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec lobortis pretium ultricies. Phasellus mattis, eros vitae accumsan malesuada</h5>
                    <p style="color: white;">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit,
        ...
        <div class="gallery" id="specials">
            <div class="container">
                    <div class="wthree-heading">
                        <h3 style="color: white;">Nuestros Escpeciales</h3>
                    </div>
